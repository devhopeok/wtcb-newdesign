...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__notification_notification__ = __webpack_require__(140);
...
ListPage = ListPage_1 = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        selector: 'page-list',template:/*ion-inline-start:"/Volumes/data/Git Repos/wtcb-newdesign/src/pages/list/list.html"*/'<ion-header>\n  <ion-navbar>\n    <button ion-button menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n    <ion-title>List</ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content>\n  <ion-list>\n    <button ion-item *ngFor="let item of items" (click)="itemTapped($event, item)">\n      <ion-icon [name]="item.icon" item-start></ion-icon>\n      {{item.title}}\n      <div class="item-note" item-end>\n        {{item.note}}\n      </div>\n    </button>\n  </ion-list>\n  <div *ngIf="selectedItem" padding>\n    You navigated here from <b>{{selectedItem.title}}</b>\n  </div>\n</ion-content>\n'/*ion-inline-end:"/Volumes/data/Git Repos/wtcb-newdesign/src/pages/list/list.html"*/
    }),
        ...
        if (this.create_or_update == false) {
            ...
            this.userService.createRequest(this.otrsRequest)
                ...
                if (data.message == "Success") {
                    ...
                    _this.pushService.notiBuildingManagerForRequest(requestKey, "Usted a recibido una nueva solicitud", _this.token);
...
var MaintenanceTrackerPage = (function () {
    ...
    MaintenanceTrackerPage.prototype.denyQuote1 = function () {
        ...
        modal.onDidDismiss(function (data) {
            ...
            _this.pushService.notiBuildingManagerForRequest(_this.request._id, _this.office.name + " rechazo la cotización.", _this.token);
...
MyApp = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({template:/*ion-inline-start:"/Volumes/data/Git Repos/wtcb-newdesign/src/app/app.html"*/'<ion-menu [content]="content">\n  <ion-header>\n    <ion-toolbar>\n      <ion-title>Menú</ion-title>\n    </ion-toolbar>\n  </ion-header>\n\n  <ion-content>\n    <ion-list no-lines>\n      <ion-item menuClose ion-item *ngFor="let p of pages" (click)="openPage(p)" style="color: rgb(70, 95, 110);">\n        <ion-icon name="{{p.icon}}"></ion-icon>\n        {{p.title}}\n        <div item-end *ngIf="p.title==\'Notificaciones\' && count>0" class="notification-count">{{count}}</div>\n      </ion-item>\n    </ion-list>\n  </ion-content>\n\n</ion-menu>\n\n<!-- Disable swipe-to-go-back because it\'s poor UX to combine STGB with side menus -->\n<ion-nav [root]="rootPage" #content swipeBackEnabled="false"></ion-nav>'/*ion-inline-end:"/Volumes/data/Git Repos/wtcb-newdesign/src/app/app.html"*/
    }),
